...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'rockart_v5data/rockart_v5_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'rockart_v5data/rockart_v5_messages_','.xml');
}
...
function addKolorAnalytics(pPlugID) 
{
	...
	{
		var kolorAnalyticsJS = new ktools.Script("KolorAnalyticsJS", crossDomainTargetUrl+"rockart_v5data/graphics/KolorAnalytics/KolorAnalytics.min.js", [], true);
...
function addKolorBox(pPlugID)
{
	...
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"rockart_v5data/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"rockart_v5data/graphics/KolorBox/KolorBox.min.js", [], true);
